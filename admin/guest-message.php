...
{
$adminid=$_GET['id'];
$msg=mysqli_query($con,"delete from gmessage where id='$adminid'");
if($msg)
{
...
<html lang="en">
  <head>
    ...
    <title>Admin | Guest messages</title>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($con,"select * from gmessage");
							  $cnt=1;
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td>
                                     ...
                                     <a href="show-guest.php?uid=<?php echo $row['id'];?>">
                                     <button class="btn btn-primary btn-xs"><i class="fa fa-search-plus"></i></button></a>
                                     <a href="guest-message.php?id=<?php echo $row['id'];?>">
