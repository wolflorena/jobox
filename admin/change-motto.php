...
if(isset($_POST['changemotto']))
{
	$id = $_POST['id'];
	$mottom=$_POST['mottom'];
	$msg=mysqli_query($con,"update motto set mottom='$mottom' where id='1'");
if($msg)
{
	$_SESSION['msg']="moto schimbat.";
}
}
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Change index motto </h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="mottom" value="" required value="{Your career starts here}" >
                              </div>
                          </div>
                          <div style="margin-left:100px;">
                          <input type="submit" name="changemotto" value="Change" class="btn btn-theme"></div>
                          </form>
                      </div>
                  </div>
              </div>
