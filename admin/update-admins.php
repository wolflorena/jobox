...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update admin set username='$username' ,password='$password' where id='$uid'");
...
<html lang="en">
  <head>
    ...
    <title>Admin | Update Admins</title>
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from admin where id='".$_GET['uid']."'");
	  while($row=mysqli_fetch_array($ret))

	  {?>
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Administrator <?php echo $row['username'];?>'s Information</h3>
